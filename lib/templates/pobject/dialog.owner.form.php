...
<fieldset id="data" class="browse">
		...
		<div class="field">
			...
			<input class="button" type="button" value="<?php echo $ARnls['browse']; ?>" title="<?php echo $ARnls['browse']; ?>" onclick='callbacktarget="extrauser"; window.open("<?php echo $this->make_local_url('/system/users/'); ?>" + "dialog.browse.php", "browse", "height=480,width=750"); return false;'>
		</div>
