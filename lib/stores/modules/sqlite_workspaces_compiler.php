...
class sqlite_workspaces_compiler extends sqlite_compiler {

	public function __construct (&$store, $tbl_prefix="") {
		debug("sqlite_workspaces_compiler($tbl_prefix)", "store");
		$this->tbl_prefix=$tbl_prefix;
		$this->store=$store;
	}

	// sqlite specific compiler function
	protected function priv_sql_compile($tree) {
		...
		$select_query .= "$objects.lastchanged as lastchanged  ";
