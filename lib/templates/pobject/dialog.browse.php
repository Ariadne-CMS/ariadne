	...
	if ($this->CheckLogin("read") && $this->CheckConfig()) {
		...
		$menuitems = array(
			...
			array(
				...
				'href' => $this->make_local_url($this->parent) . "dialog.browse.php",
...
<body class="yui-skin-sam">
	...
	<div id="explore_tree">
		<div id="treeDiv"></div>
		<div id="treecontrol">
			<a href="#" onclick="muze.ariadne.explore.tree.init(); return false;" title="Refresh"><img src="<?php echo $wwwroot;?>images/icons/medium/refresh.png" alt="Refresh">Refresh</a>
		</div>
