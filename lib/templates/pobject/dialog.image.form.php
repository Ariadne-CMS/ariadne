...
<fieldset id="data" class="browse">
		...
		<div class="field">
			...
			<input class="button" type="button" value="<?php echo $ARnls['browse']; ?>" title="<?php echo $ARnls['browse']; ?>" onclick='callbacktarget="extrauser"; window.open("<?php echo $this->make_local_url($wgBrowsePath); ?>" + "dialog.browse.php", "browse", "height=480,width=920"); return false;'>
		</div>
		<div class="field">
