<?php
	...
	$ARnls['install:check_long_arrays']	= 'PHP ondersteund long arrays';
	...
	$ARnls['install:check_nls']		= 'NLS map is readable';
	...
	$ARnls['install:check_db_is_empty']	= 'Gekoezen database voor installatie is leeg';
