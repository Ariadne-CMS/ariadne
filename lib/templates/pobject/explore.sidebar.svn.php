	...
	if ($this->CheckLogin("read") && $this->CheckConfig()) {
		...
		if ($this->CheckSilent("layout")) {
			if ($svn_revision) {
				...
				$tasks[] = array(
					'href' => $this->make_local_url() . 'dialog.svn.tree.info.php',
				...
				$tasks[] = array(
					'href' => $this->make_local_url() . 'dialog.svn.tree.diff.php',
				...
				$tasks[] = array(
					'href' => $this->make_local_url() . 'dialog.svn.tree.commit.php',
				...
				$tasks[] = array(
					'href' => $this->make_local_url() . 'dialog.svn.tree.revert.php',
				...
				$tasks[] = array(
					'href' => $this->make_local_url() . 'dialog.svn.tree.update.php',
				...
				$tasks[] = array(
					'href' => $this->make_local_url() . 'dialog.svn.tree.unsvn.php',
				...
				$tasks[] = array(
					'href' => $this->make_local_url() . 'dialog.svn.tree.checkout.php',
				...
				$tasks[] = array(
					'href' => $this->make_local_url() . 'dialog.svn.tree.import.php',
