<?php
    ...
    ******************************************************************/
	...
	if (!$AR_PATH_INFO) {
		...
		if (Headers_sent()) {
			error("The loader has detected that PHP has already sent the HTTP Headers. This error is usually caused by trailing white space or newlines in the configuration files
. See the following error message for the exact file that is causing this:");
