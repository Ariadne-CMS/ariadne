/**
 * $Id: editor_template_src.js 237 2007-03-06 21:32:42Z spocke $
 *
 * @author Moxiecode
...
var TinyMCE_AdvancedTheme = {
	...
	_insertImage : function(src, alt, border, hspace, vspace, width, height, align, title, onmouseover, onmouseout, arpath, artype) {
		...
		if (!tinyMCE.imgElement && tinyMCE.isSafari) {
			...
			html += ' ar:path="' + arpath + '" ar:type="' + artype + '"';
		...
		if (tinyMCE.imgElement) {
			...
			tinyMCE.setAttrib(tinyMCE.imgElement, 'ar:path', arpath);
			tinyMCE.setAttrib(tinyMCE.imgElement, 'ar:type', artype);
	...
	_insertLink : function(href, target, title, onclick, style_class, artype, arpath, arnls, name) {
		tinyMCE.execCommand('mceBeginUndoLevel');
		...
		if (tinyMCE.selectedInstance && tinyMCE.selectedElement && tinyMCE.selectedElement.nodeName.toLowerCase() == "img") {
			...
			tinyMCE.setAttrib(linkElement, 'ar:path', arpath);
			tinyMCE.setAttrib(linkElement, 'ar:type', artype);
			tinyMCE.setAttrib(linkElement, 'ar:nls', arnls);
			tinyMCE.setAttrib(linkElement, 'name', name);
		...
		if (!tinyMCE.linkElement && tinyMCE.selectedInstance) {
			...
			for (var i=0; i<elementArray.length; i++) {
				...
				tinyMCE.setAttrib(elementArray[i], 'ar:path', arpath);
				tinyMCE.setAttrib(elementArray[i], 'ar:type', artype);
				tinyMCE.setAttrib(elementArray[i], 'ar:nls', arnls);
				tinyMCE.setAttrib(elementArray[i], 'name', name);
			}
		...
		if (tinyMCE.linkElement) {
			...
			tinyMCE.setAttrib(tinyMCE.linkElement, 'ar:path', arpath);
			tinyMCE.setAttrib(tinyMCE.linkElement, 'ar:type', artype);
			tinyMCE.setAttrib(tinyMCE.linkElement, 'ar:nls', arnls);
			tinyMCE.setAttrib(tinyMCE.linkElement, 'name', name);
		}
